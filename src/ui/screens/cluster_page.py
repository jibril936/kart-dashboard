...
class ClusterPage(QWidget):
    def __init__(self, store, parent=None):
        ...
        self.store = store
        self.v_temp = 0.0  # Mémoire pour calcul des kW
    ...
    def setup_ui(self):
        ...
        # 1. BARRE D'ALERTES INTÉGRÉE (Icônes READY, BRAKE, etc.)
        self.alert_bar = IconAlertBar()
        self.main_layout.addWidget(self.alert_bar)

        # 2. ZONE DE CONTENU PRINCIPALE (Compteurs + Cercle)
        ...
        # On réduit à 260px pour laisser respirer le centre
        ...
        # --- COLONNE CENTRALE (Cercle d'Énergie SOC%) ---
    ...
    def connect_signals(self):
        ...
        # Alertes Température automatiques
    ...
    def _on_voltage(self, volts):
        self.v_temp = volts
        self.energy_circle.update_status(self.store.get_soc())